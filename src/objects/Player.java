...
public class Player extends GameObject implements EventHandler<Event> {
    ...
    public static double MOUSE_SENSITIVITY = 0.05;
    ...
    private static final double INTERACTION_FIELD_RADIUS = 20;
    private static final double INTERACTION_FIELD_LENGTH = 140;
    private Cylinder interactionField;
    ...
    public Player(Vector position, Game game) {
        ...
        interactionField = new Cylinder(INTERACTION_FIELD_RADIUS, INTERACTION_FIELD_LENGTH);
        interactionField.setRotationAxis(Rotate.X_AXIS);
        interactionField.setRotate(-90);
        interactionField.setTranslateZ(INTERACTION_FIELD_LENGTH / 2);
        interactionField.setMaterial(transparentMaterial);
        head.getChildren().add(interactionField);
    ...
    public Bounds getInteractionBounds() {
        return this.localToParent(head.localToParent(interactionField.getBoundsInParent()));
    }
    ...
    private void handleKeyEvent(KeyEvent e) {
        ...
        if (e.getCode() == KeyCode.E && e.getEventType() == KeyEvent.KEY_PRESSED) {
            if (!interactButtonPressed) {
                game.interact();
                interactButtonPressed = true;
            }
        } else if (e.getCode() == KeyCode.E && e.getEventType() == KeyEvent.KEY_RELEASED) {
            interactButtonPressed = false;
        } else if (e.getCode() == KeyCode.DIGIT1 && e.getEventType() == KeyEvent.KEY_PRESSED) {
            game.setCamera(0);
        } else if (e.getCode() == KeyCode.DIGIT2 && e.getEventType() == KeyEvent.KEY_PRESSED) {
            game.setCamera(1);
        } else if (e.getCode() == KeyCode.DIGIT3 && e.getEventType() == KeyEvent.KEY_PRESSED) {
            game.setCamera(2);
        } else if (e.getCode() == KeyCode.DIGIT4 && e.getEventType() == KeyEvent.KEY_PRESSED) {
            game.setCamera(3);
        } else if (e.getCode() == KeyCode.DIGIT5 && e.getEventType() == KeyEvent.KEY_PRESSED) {
            game.setCamera(4);
        } else if (e.getCode() == KeyCode.DIGIT6 && e.getEventType() == KeyEvent.KEY_PRESSED) {
            game.setCamera(5);
        }
